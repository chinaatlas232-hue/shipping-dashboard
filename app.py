...
# تعيين أسماء الأعمدة الحقيقية للعمليات الحسابية
...
# تحويل كافة الأعمدة إلى قيم رقمية نظيفة وحذف الرموز النصية لمنع التكرار والأخطاء
...
# --- 6. معالجة المؤشرات الحسابية ومنع تكرار الكراتين والحجم بشكل نهائي ---
...
# 🌟 الحل القاطع لمنع تضاعف الكراتين والحجم: 
# نقوم بحساب مجموع الكراتين والحجم بناءً على الأسطر الأصلية فقط لكل حاوية دون تكرار
if selected_container != "الكل":
